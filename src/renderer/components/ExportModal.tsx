...
const FORMAT_OPTIONS: { id: Format; label: string; desc: string; icon: React.ReactNode }[] = [
...
export const ExportModal: React.FC<Props> = ({ session, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="w-[440px] bg-[#111] border border-white/10 rounded-2xl shadow-2xl p-6 flex flex-col gap-5"
      ...
      >
        ...
        <div className="flex gap-2 justify-end pt-1">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 text-sm font-medium bg-terra-500 hover:bg-terra-400 disabled:opacity-60 text-white rounded-xl transition-colors"
          >
            {done
              ? <><Check size={13} /> Saved!</>
              : saving
