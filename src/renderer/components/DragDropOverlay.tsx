...
interface Props {
  onFiles: (files: Array<{ name: string; mimeType: string; content: string }>) => void
}

export const DragDropOverlay: React.FC<Props> = ({ onFiles }) => {
  ...
  useEffect(() => {
    ...
    const onDrop = async (e: DragEvent) => {
      ...
      const results: Array<{ name: string; mimeType: string; content: string }> = []
